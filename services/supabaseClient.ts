...
const loadSupabaseConfig = (): SupabaseConfig => {
...
export const isSupabaseConfigured = (): boolean => loadSupabaseConfig().isConfigured;

export const getSupabaseClient = (): SupabaseClient => {
  if (cachedSupabase) return cachedSupabase;

  const { url: supabaseUrl, anonKey: supabaseAnonKey, isConfigured } = loadSupabaseConfig();
