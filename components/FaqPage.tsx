      ...
      <main className="max-w-5xl mx-auto px-6 py-12 md:py-20">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-dark-900 border border-dark-700 rounded-2xl p-6 md:p-7">
            <h2 className="text-white font-semibold text-lg mb-2">Sommet, c’est quoi concrètement ?</h2>
            ...
            <div className="bg-dark-800/60 border border-dark-700 rounded-xl p-4 text-sm text-slate-300">
              <p className="font-semibold text-white mb-1">Ce que vous gagnez immédiatement :</p>
          ...
          {/* Q2 */}
          <div className="bg-dark-900 border border-dark-700 rounded-2xl p-6 md:p-7">
            <h2 className="text-white font-semibold text-lg mb-2">Pourquoi passer sur un plan payant ?</h2>
            <p className="text-slate-400 text-sm md:text-base leading-relaxed mb-3">
          ...
          {/* Q3 */}
          <div className="bg-dark-900 border border-dark-700 rounded-2xl p-6 md:p-7">
            <h2 className="text-white font-semibold text-lg mb-2">Combien ça coûte et quel plan choisir ?</h2>
          ...
          {/* Q4 */}
          <div className="bg-dark-900 border border-dark-700 rounded-2xl p-6 md:p-7">
            <h2 className="text-white font-semibold text-lg mb-2">Et si je ne suis pas technique ?</h2>
            <p className="text-slate-400 text-sm md:text-base leading-relaxed mb-3">
          ...
          {/* Q5 */}
          <div className="bg-dark-900 border border-dark-700 rounded-2xl p-6 md:p-7">
            <h2 className="text-white font-semibold text-lg mb-2">Qu’est-ce qui se passe si j’arrête mon abonnement ?</h2>
            <p className="text-slate-400 text-sm md:text-base leading-relaxed mb-3">
          ...
          {/* Q6 */}
          <div className="bg-dark-900 border border-dark-700 rounded-2xl p-6 md:p-7">
            <h2 className="text-white font-semibold text-lg mb-2">Comment Sommet me fait gagner du temps… et de l’argent ?</h2>
            <p className="text-slate-400 text-sm md:text-base leading-relaxed mb-3">
          ...
          {/* Q7 */}
          <div className="bg-dark-900 border border-dark-700 rounded-2xl p-6 md:p-7">
            <h2 className="text-white font-semibold text-lg mb-2">Qui peut m’accompagner si je bloque ?</h2>
            <p className="text-slate-400 text-sm md:text-base leading-relaxed mb-3">
            ...
            <div className="bg-dark-800/60 border border-dark-700 rounded-xl p-4 text-sm text-slate-300 flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
              <div>
